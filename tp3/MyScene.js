...
export class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        // Wood-like material (low specular)
        this.material4 = new CGFappearance(this);
        this.material4.setAmbient(0.30, 0.18, 0.08, 1.0);
        this.material4.setDiffuse(0.56, 0.34, 0.17, 1.0);
        this.material4.setSpecular(0.08, 0.05, 0.02, 1.0);
        this.material4.setShininess(6.0);
